...
> 2. CI (Continious Integration) via GitHub Actions with linters, tests, scanners and image creation.
>    - ESLint
>    - Prettier
>    - Tests
>    - SonarQube
...
> 2. CD via GitHub Actions. Three-Tier Architecture on AWS, using Terraform and ArgoCD
>    - VPC
