...
`}),$o={separator:"separator",presentation:"presentation"},wo={horizontal:"horizontal",vertical:"vertical"};class ko extends Ae{constructor(){super(...arguments),this.role=$o.separator,this.orientation=wo.horizontal}}M([P],ko.prototype,"role",void 0),M([P],ko.prototype,"orientation",void 0);class Io extends ko{}const To=Io.compose({baseName:"divider",template:(e,t)=>Ft`
...
`,shadowOptions:{delegatesFocus:!0}});class Yo extends Ao{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Jo=Yo.compose({baseName:"option",template:(e,t)=>Ft`
    <template
...
`}),kn={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class In extends Ae{}class Tn extends(gs(In)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const On={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Sn extends Tn{constructor(){super(...arguments),this.type=On.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({attribute:"readonly",mode:"boolean"})],Sn.prototype,"readOnly",void 0),M([P({mode:"boolean"})],Sn.prototype,"autofocus",void 0),M([P],Sn.prototype,"placeholder",void 0),M([P],Sn.prototype,"type",void 0),M([P],Sn.prototype,"list",void 0),M([P({converter:D})],Sn.prototype,"maxlength",void 0),M([P({converter:D})],Sn.prototype,"minlength",void 0),M([P],Sn.prototype,"pattern",void 0),M([P({converter:D})],Sn.prototype,"size",void 0),M([P({mode:"boolean"})],Sn.prototype,"spellcheck",void 0),M([v],Sn.prototype,"defaultSlottedNodes",void 0);class En{}Zi(En,Ki),Zi(Sn,Xi,En);class Rn extends Ae{}class An extends(gs(Rn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class Dn extends An{constructor(){super(...arguments),this.resize=kn.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({mode:"boolean"})],Dn.prototype,"readOnly",void 0),M([P],Dn.prototype,"resize",void 0),M([P({mode:"boolean"})],Dn.prototype,"autofocus",void 0),M([P({attribute:"form"})],Dn.prototype,"formId",void 0),M([P],Dn.prototype,"list",void 0),M([P({converter:D})],Dn.prototype,"maxlength",void 0),M([P({converter:D})],Dn.prototype,"minlength",void 0),M([P],Dn.prototype,"name",void 0),M([P],Dn.prototype,"placeholder",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"cols",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"rows",void 0),M([P({mode:"boolean"})],Dn.prototype,"spellcheck",void 0),M([v],Dn.prototype,"defaultSlottedNodes",void 0),Zi(Dn,En);class Bn extends Dn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Pn=Bn.compose({baseName:"text-area",template:(e,t)=>Ft`
    <template
        class="
